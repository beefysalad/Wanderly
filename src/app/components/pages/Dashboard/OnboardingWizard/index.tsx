          ...
          {step === "WELCOME" && (
            ...
            >
              ...
              <p className='text-lg text-slate-400 mb-8 max-w-md mx-auto'>
                Your ultimate companion for group travel. Plan trips, split
                ...
                <div className='space-y-8'>
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      placeholder='Share a bit about your travel style or interests...'
                    />
                  </div>
            ...
            >
              <AnimatePresence mode='wait'>
                {tutorialStep === 0 && (
                  ...
                  >
                    ...
                    <p className='text-slate-400 mb-8 max-w-md mx-auto'>
                      First, create a <strong>Group</strong> for your squad.
                      This is your hub where you can plan multiple trips
                      together.
                    </p>
                  </motion.div>
                )}
                {tutorialStep === 1 && (
                  ...
                  >
                    ...
                    <p className='text-slate-400 mb-8 max-w-md mx-auto'>
                      Inside your group, create a <strong>Trip</strong>. Then,
                      build your itinerary by adding <strong>Activities</strong>{" "}
                      for each day.
                    </p>
                  </motion.div>
                )}
                {tutorialStep === 2 && (
                  ...
                  >
                    ...
                    <p className='text-slate-400 mb-8 max-w-md mx-auto'>
                      Finally, add <strong>Expenses</strong> directly to any
                      Activity (or the Trip itself). We&apos;ll handle the
                      splitting math for you.
                    </p>
                  </motion.div>
                )}
              </AnimatePresence>
              ...
              <div className='flex items-center justify-center gap-2 mb-8'>
                {[0, 1, 2].map((i) => (
                  <div
                    key={i}
                    className={`w-2 h-2 rounded-full transition-colors ${i === tutorialStep ? "bg-amber-500" : "bg-slate-700"}`}
                  />
                ))}
              </div>
