      ...
      >
        <div className='px-4 sm:px-3'>
          <div className='flex items-center justify-center gap-6 sm:gap-8 sm:justify-start'>
            ...
            >
              <LayoutDashboard className='w-5 h-5 transition-transform duration-300 ease-in-out group-hover:scale-110' />
            ...
            >
              ...
              <span className='hidden sm:inline-block sm:opacity-0 sm:max-w-0 sm:h-0 sm:group-hover:opacity-100 sm:group-hover:max-w-[80px] sm:group-hover:h-auto sm:group-hover:mt-0.5 overflow-hidden transition-all duration-300 ease-in-out whitespace-nowrap text-center'>
                Trips
              </span>
              {activeTab === "trips" && (
                <div className='absolute bottom-0 left-0 right-0 h-0.5 bg-orange-600 dark:bg-orange-400 opacity-0 group-hover:opacity-100 transition-opacity duration-300' />
            ...
            >
              <Building2 className='w-5 h-5 transition-transform duration-300 ease-in-out group-hover:scale-110' />
              <span className='hidden sm:inline-block sm:opacity-0 sm:max-w-0 sm:h-0 sm:group-hover:opacity-100 sm:group-hover:max-w-[90px] sm:group-hover:h-auto sm:group-hover:mt-0.5 overflow-hidden transition-all duration-300 ease-in-out whitespace-nowrap text-center'>
                Groups
              </span>
              {activeTab === "groups" && (
                <div className='absolute bottom-0 left-0 right-0 h-0.5 bg-orange-600 dark:bg-orange-400 opacity-0 group-hover:opacity-100 transition-opacity duration-300' />
            ...
            >
              <User className='w-5 h-5 transition-transform duration-300 ease-in-out group-hover:scale-110' />
              <span className='hidden sm:inline-block sm:opacity-0 sm:max-w-0 sm:h-0 sm:group-hover:opacity-100 sm:group-hover:max-w-[80px] sm:group-hover:h-auto sm:group-hover:mt-0.5 overflow-hidden transition-all duration-300 ease-in-out whitespace-nowrap text-center'>
                Profile
              </span>
              {activeTab === "profile" && (
