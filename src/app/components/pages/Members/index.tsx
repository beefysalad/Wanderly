                ...
                >
                  <div className='flex flex-col gap-4'>
                    <div className='flex items-start gap-4'>
                      {memberMeta?.imageUrl ? (
                        <div className='relative w-14 h-14 rounded-full overflow-hidden border-2 border-slate-200 shadow-lg flex-shrink-0 group-hover:scale-110 transition-transform duration-300'>
                          <Image
