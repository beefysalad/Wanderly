  ...
  return (
    <Fragment>
      ...
      <div className='space-y-4 animate-slide-in-left'>
        ...
        <p
          className='text-base md:text-lg text-slate-300 leading-relaxed animate-fade-in-up'
          style={{ animationDelay: "0.1s" }}
        >
          Collaborate with friends in{" "}
          <strong className='text-amber-400'>real-time</strong>. Create group
          trips, share itineraries, and keep{" "}
          <strong className='text-orange-400'>everyone synchronized</strong>.
        </p>
      </div>
      ...
      >
        ...
        >
          ...
          <p className='text-slate-300 text-sm group-hover:text-white transition-colors'>
            Share group codes and invite friends{" "}
            <strong className='text-amber-400'>instantly</strong>
          </p>
        </div>
        <div
          className='flex gap-3 items-start group hover:translate-x-1 transition-transform duration-300'
        ...
        >
          ...
          <p className='text-slate-300 text-sm group-hover:text-white transition-colors'>
            <strong className='text-orange-400'>Real-time</strong> updates and
            activity management
          </p>
        </div>
        <div
        ...
        >
          ...
          <p className='text-slate-300 text-sm group-hover:text-white transition-colors'>
            Export to your{" "}
            <strong className='text-amber-400'>phone calendar</strong> (Google,
            Apple, Outlook)
          </p>
        </div>
      </div>
