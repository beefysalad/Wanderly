                ...
                <div className='flex-1 min-w-0'>
                  <div className='flex items-center gap-2 mb-1'>
                    ...
                    {budget.isBooked ? (
                      ...
                      <span className='flex items-center gap-1 px-2 py-0.5 rounded-full bg-orange-500/10 border border-orange-500/20 text-[10px] font-bold text-orange-400 uppercase tracking-wider'>
