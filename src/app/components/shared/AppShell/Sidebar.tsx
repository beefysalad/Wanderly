...
export function Sidebar() {
  ...
  return (
    <aside className='sticky top-0 z-[2] hidden h-screen w-[236px] flex-none flex-col gap-[26px] overflow-y-auto border-r border-white/[.06] bg-[rgba(2,6,23,.72)] px-[14px] py-5 [scrollbar-width:none] md:flex'>
      <Link href='/dashboard' className='flex items-center gap-[10px] px-2 text-inherit'>
        ...
        {NAV_ITEMS.map(({ key, label, href, icon: Icon }) => (
          ...
          >
            ...
            {key === "notifications" && unreadCount > 0 ? (
              <span className='rounded-full bg-[#fbbf24] px-[7px] py-px text-[11px] font-extrabold text-[#160c02]'>
      ...
      <Link
        href='/profile'
        className='mt-auto flex items-center gap-[10px] rounded-[14px] border border-white/[.06] bg-[rgba(15,23,42,.6)] p-[10px] text-inherit'
      >
